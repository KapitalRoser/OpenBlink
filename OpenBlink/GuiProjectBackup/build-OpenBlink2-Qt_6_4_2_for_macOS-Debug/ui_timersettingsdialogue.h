...
public:
    ...
    void setupUi(QDialog *timerSettingsDialogue)
    {
        if (timerSettingsDialogue->objectName().isEmpty())
            timerSettingsDialogue->setObjectName("timerSettingsDialogue");
        ...
        exitBeepsBox->setObjectName("exitBeepsBox");
        ...
        exitOffsetBox->setObjectName("exitOffsetBox");
        ...
        exitIntervalBox->setObjectName("exitIntervalBox");
...
"}"));
        ...
        exitInputBox->setObjectName("exitInputBox");
