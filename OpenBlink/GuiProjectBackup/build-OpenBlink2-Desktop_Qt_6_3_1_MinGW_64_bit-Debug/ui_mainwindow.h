...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        LogoLabel->setGeometry(QRect(20, 10, 221, 51));
        QFont font1;
...
"}"));
        ...
        BodyHoriz->setStretch(0, 3);
        BodyHoriz->setStretch(1, 2);
