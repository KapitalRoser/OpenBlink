...
#include <memory>
#include "../OpenBlink2/logwindow.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_LogWindow_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_LogWindow_t qt_meta_stringdata_LogWindow = {
    {
        QT_MOC_LITERAL(0, 9),  // "LogWindow"
        QT_MOC_LITERAL(10, 19),  // "on_okButton_clicked"
        QT_MOC_LITERAL(30, 0),  // ""
        QT_MOC_LITERAL(31, 21)   // "on_copyButton_clicked"
    },
    "LogWindow",
    "on_okButton_clicked",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_LogWindow[] = {
...
Q_CONSTINIT const QMetaObject LogWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_LogWindow.offsetsAndSizes,
